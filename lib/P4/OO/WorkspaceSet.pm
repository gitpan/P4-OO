...
#
    package P4::OO::WorkspaceSet;
    our $VERSION = '0.00_02';
    use base 'P4::OO::ClientSet';
    use strict;


######################################################################
#
# P4::OO::WorkspaceSet is just a stub, P4::OO::ClientSet does all the work
#
######################################################################
...
P4::OO::WorkspaceSet is Copyright (c)2010-2011, David L. Armstrong.
